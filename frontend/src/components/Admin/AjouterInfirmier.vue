<template>
    <div class="container mx-auto p-4">
      <h2 class="text-xl font-bold mb-4">Ajouter un infirmier</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          ...
          <div>
            ...
            <div class="mb-3">
              ...
              <input 
                v-model="personnel.qualification" 
                type="text" 
                required
                class="w-full p-2 border rounded"
                placeholder="Ex: Infirmier(e) diplômé(e) d'État"
              />
            </div>
        ...
        axios
          ...
          .catch(error => {
            ...
            this.afficherMessage(
              "Erreur lors de l'ajout de l'infirmier: " + 
