        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          ...
          <div>
            ...
            <div class="mb-3">
              ...
              <select 
                v-model="sejour.id_admin_affectation" 
                required
                class="w-full p-2 border rounded"
              >
                <option value="">Sélectionnez un administratif</option>
                <option v-for="admin in personnelsAdmin" :key="admin.id_admin" :value="admin.id_admin">
  ...
  export default {
    ...
    methods: {
      ...
      chargerChambres() {
        ...
        axios.get(`http://localhost:3002/chambres/service/${this.service}`)
          .then(response => {
      ...
      chargerLits() {
        ...
        axios.get(`http://localhost:3002/lits/disponibles/chambre/${this.chambre}`)
          .then(response => {
      ...
      soumettreFormulaire() {
        ...
        if (!this.sejour.id_patient || !this.sejour.id_lit || !this.sejour.date_arrivee || 
            !this.sejour.raison_sejour || !this.sejour.id_admin_affectation) {
        ...
        axios
          .post("http://localhost:3002/sejours", this.sejour)
          .then(() => {
