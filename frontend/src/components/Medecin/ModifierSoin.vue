  ...
  <div class="modifier-soin">
    ...
    <div v-if="!selectedSoin" class="selection-section">
      ...
      <table class="soins-table">
        ...
        <tbody>
          <tr v-if="loading">
            <td colspan="5" class="centered">Chargement...</td>
          </tr>
      ...
      <form @submit.prevent="submitForm" class="soin-form">
        ...
        <div class="form-section">
          ...
          <div class="medicaments-list">
            ...
            <div
              class="no-medicaments"
              v-if="formData.medicaments.length === 0"
            >
  ...
  computed: {
    ...
    isFormValid() {
      ...
      if (
        ...
        !this.formData.id_patient ||
        !this.formData.id_reunion_decision
      ) {
        return false;
      }
